...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/iframeCrossOriginUpload")
	public ModelAndView iframeCrossOriginUpload(HttpServletRequest request, ModelAndView mav) throws Exception {
...
//		}
		...
		String url = MASTER_DOMAIN + "crossOrigin/receiveVal.jsp";
